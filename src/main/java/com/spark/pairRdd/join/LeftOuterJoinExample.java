...
public class LeftOuterJoinExample {
  ...
  public static void main(String[] args) {
    ...
    JavaPairRDD<String, Tuple2<Integer, Optional<String>>> leftOuterJoinRdd = ages.leftOuterJoin(address);

    leftOuterJoinRdd.saveAsTextFile("out/leftOuterJoin_pairRdd");
  }
}
