...
public class RightOuterJoinExample {
  ...
  public static void main(String[] args) {
    ...
    JavaPairRDD<String, Tuple2<Optional<Integer>, String>> rightOuterJoinedRdd = ages.rightOuterJoin(address);

    rightOuterJoinedRdd.saveAsTextFile("out/rightOuterJoin_pairRdd");
  }
}
